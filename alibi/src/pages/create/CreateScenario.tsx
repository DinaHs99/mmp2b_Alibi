...
const SCENARIOS = [
  {
    ...
    description: 'The reveal cake was found collapsed in the fridge, with blue frosting scraped away and the candles hidden.',
    difficulty: 'Easy',
    icon: '🎂',
  },
  {
    ...
    description: 'The group gift card vanished from a resealed envelope after the black tote bag mysteriously moved.',
    difficulty: 'Easy',
    icon: '🎁',
  },
  {
    ...
    description: 'The final file vanished before submission, the backup was renamed, and the edit history exposes the trick.',
    difficulty: 'Medium',
    icon: '💻',
  },
  {
    ...
    description: 'A secret party plan leaked into the wrong chat, then the message disappeared before anyone admitted it.',
    difficulty: 'Easy',
    icon: '🎈',
  },
  {
    ...
    description: 'The shared notes were swapped with an old draft full of wrong formulas and a suspicious answer key.',
    difficulty: 'Medium',
    icon: '📚',
  },
]
