...
const SCENARIOS = [
  {
    ...
    description: 'A birthday cake was found collapsed before the party reveal. The box was opened, frosting was scraped, and the candles vanished.',
    difficulty: 'Easy',
    icon: '🎂',
  },
  {
    id: '1e6bee59-fbaa-4c77-93b2-2462dee27319',
    title: 'The Missing Gift Card',
    description: 'The group gift card disappeared from its envelope before the handover. The envelope was resealed, but badly.',
    difficulty: 'Easy',
    icon: '🎁',
  },
  {
    id: '99df3dd6-a517-4ae5-a28f-233ceb466652',
    title: 'The Deleted Group Project',
    description: 'The final project file vanished one hour before submission. The backup was renamed and the edit history tells a story.',
    difficulty: 'Medium',
    icon: '💻',
  },
  {
    id: '73436bb5-6c55-429a-8af3-fe74879438b2',
    title: 'The Spoiled Surprise Party',
    description: 'Someone leaked the surprise party in the wrong chat, deleted the message, and acted shocked when the surprise failed.',
    difficulty: 'Easy',
    icon: '🎈',
  },
  {
    id: '14ddb747-a8f7-4f5a-9d68-cbff14242588',
    title: 'The Swapped Exam Notes',
    description: 'The shared study notes were replaced with an older version full of wrong formulas and suspicious edits.',
    difficulty: 'Medium',
    icon: '📚',
  },
]
